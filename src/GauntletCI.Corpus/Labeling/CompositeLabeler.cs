...
public sealed class CompositeLabeler
{
    ...
    private static string ClassifyLabel(FixtureSignals s)
    {
        ...
        if (hasScannerMatch && hasLowValidation)
        {
            return LabelHighRiskGhost;
        }

        // Scanner match but well-reviewed is still a real finding
        if (hasScannerMatch && hasHighValidation)
        {
            return LabelHighRiskGhost;
        }
    ...
    private static void IncrementBucket(CompositeLabelerResult r, string label)
    {
        switch (label)
        {
            case LabelDependabotFix:
                r.DependabotFix++;
                break;
            case LabelHighRiskGhost:
                r.HighRiskGhost++;
                break;
            case LabelSilentLogicChange:
                r.SilentLogicChange++;
                break;
            case LabelUnvalidatedBehavioralRisk:
                r.UnvalidatedBehavioralRisk++;
                break;
            case LabelHotPathUnreviewed:
                r.HotPathUnreviewed++;
                break;
            case LabelStandardChange:
                r.StandardChange++;
                break;
            default:
                r.InsufficientData++;
    ...
    {
        if (!LabelRuleMap.TryGetValue(label, out var targets))
        {
            return;
        }
    ...
    {
        public int SonarMatchCount
        {
            get; set;
        }
        public int CodeQlMatchCount
        {
            get; set;
        }
        public bool IsDependabot
        {
            get; set;
        }
        public bool HasDependabotData
        {
            get; set;
        }
        public double SocialSignalScore
        {
            get; set;
        }
        public double ReviewTimeMinutes
        {
            get; set;
        }
        ...
        public bool HasSocialSignalData
        {
            get; set;
        }
        public bool HasSemgrepData
        {
            get; set;
        }
        public int SemgrepFindingCount
        {
            get; set;
        }
        public bool HasStructuralData
        {
            get; set;
        }
        public double StructuralRiskScore
        {
            get; set;
        }
        public bool HasSensitivePath
        {
            get; set;
        }
        public int NuGetAdvisoryCount
        {
            get; set;
        }
        public bool HasNuGetAdvisoryData
        {
            get; set;
        }
        public bool HasChurnData
        {
            get; set;
        }
        public double MaxHotspotScore
        {
            get; set;
        }
        public HashSet<string> NlpMatchedRuleIds { get; set; } = new(StringComparer.Ordinal);
        public bool HasNlpData
        {
            get; set;
        }

        // Test coverage enrichment signals
        public bool HasTestCoverageData
        {
            get; set;
        }
        public bool TestCoverageGap
        {
            get; set;
        }
        public double TestToProdRatio
        {
            get; set;
        }

        // Diff entropy enrichment signals
        public bool HasEntropyData
        {
            get; set;
        }
        ...
        public int ChangeFileCount
        {
            get; set;
        }

        // EF migration enrichment signals
        public bool HasEfMigrationData
        {
            get; set;
        }
        public bool MigrationDetected
        {
            get; set;
        }
        public double MigrationConfidence
        {
            get; set;
        }

        // PR description enrichment signals
        public bool HasPrDescriptionData
        {
            get; set;
        }
        public bool IsEmptyPrBody
        {
            get; set;
        }
        public bool HasLinkedIssue
        {
            get; set;
        }
        public bool HasWipKeywords
        {
            get; set;
        }
        ...
        public bool IsFirstContributor
        {
            get; set;
        }
...
{
    public int FixturesLabeled
    {
        get; set;
    }
    public int DependabotFix
    {
        get; set;
    }
    public int HighRiskGhost
    {
        get; set;
    }
    public int SilentLogicChange
    {
        get; set;
    }
    public int UnvalidatedBehavioralRisk
    {
        get; set;
    }
    public int HotPathUnreviewed
    {
        get; set;
    }
    public int StandardChange
    {
        get; set;
    }
    public int InsufficientData
    {
        get; set;
    }
}
