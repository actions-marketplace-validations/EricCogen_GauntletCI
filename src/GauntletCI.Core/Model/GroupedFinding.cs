...
public sealed class GroupedFinding
{
    ...
    public required string WhyItMatters
    {
        get; init;
    }
    public required string SuggestedAction
    {
        get; init;
    }
    ...
    public required IReadOnlyList<int> Lines
    {
        get; init;
    }

    /// <summary>Distinct evidence strings, in first-seen order.</summary>
    public required IReadOnlyList<string> Evidence
    {
        get; init;
    }
    ...
    public ExpertFact? ExpertContext
    {
        get; init;
    }
    ...
    public TicketInfo? TicketContext
    {
        get; init;
    }
}
